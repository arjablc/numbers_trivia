...
import 'package:clean_architecture/core/platform/network_util.dart' as _i6;
...
class MockNumberTriviaRemoteDataSource extends _i1.Mock
  ...
  @override
  _i4.Future<_i2.NumberTriviaModel> getSpecifiedNumberTrivia(int? number) =>
      (super.noSuchMethod(
        Invocation.method(
          #getSpecifiedNumberTrivia,
          [number],
        ),
        returnValue:
...
/// A class which mocks [NumberTriviaLocalDataSouce].
///
/// See the documentation for Mockito's code generation for more information.
class MockNumberTriviaLocalDataSouce extends _i1.Mock
    implements _i5.NumberTriviaLocalDataSouce {
  @override
...
///
/// See the documentation for Mockito's code generation for more information.
class MockNetworkUtil extends _i1.Mock implements _i6.NetworkUtil {
  @override
